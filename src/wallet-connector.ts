...
export class WalletConnector {
    private readonly modules = [
        ...
        setupWalletConnect({
            ...
            metadata: {
              name: this.config.name, //"nanoStore App",
              description: this.config.description, // "nanoStore App Wallet Connect",
              url: this.config.url, //"https://github.com/near/wallet-selector",
              icons: this.config.icons // ["https://avatars.githubusercontent.com/u/37784886"],
            },
            chainId: this.config.chainId, // `near:${this.networkName}`,
            iconUrl: this.config.iconUrl  // "https://www.nano-store.app/assets/icons/icon-512x512.png",
          }),
    ...
    constructor(
        ...
        private config: {name: string, url: string, description: string, icons: string[], chainId: string, iconUrl: string},
